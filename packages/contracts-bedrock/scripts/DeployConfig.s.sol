...
contract DeployConfig is Script {
    ...
    address public forceReplayFaultProver;
    ...
    function read(string memory _path) public {
        ...
        forceReplayFaultProver = _readOr(_json, "$.forceReplayFaultProver", address(0));
    }
    ...
    /// @notice Allow the `forceReplayFaultProver` config to be overridden in testing environments
    function setForceReplayFaultProver(address _forceReplayFaultProver) public {
        forceReplayFaultProver = _forceReplayFaultProver;
    }
