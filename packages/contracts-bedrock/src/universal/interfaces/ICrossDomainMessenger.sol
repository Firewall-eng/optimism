...
interface ICrossDomainMessenger {
    ...
    function RELAY_MESSAGE_FORCE_REPLAY_CONFIG_NOOP_GAS() external view returns (uint64);
    function RELAY_MESSAGE_FORCE_REPLAY_CONFIG_CALL_GAS() external view returns (uint64);
